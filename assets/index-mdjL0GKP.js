 ...
 */var rm;function i0(){if(rm)return kn;rm=1;var p=Symbol.for("react.transitional.element"),w=Symbol.for("react.fragment");function R(d,O,U){var A=null;if(U!==void 0&&(A=""+U),O.key!==void 0&&(A=""+O.key),"key"in O){U={};for(var G in O)G!=="key"&&(U[G]=O[G])}else U=O;return O=U.ref,{$$typeof:p,type:d,key:A,ref:O!==void 0?O:null,props:U}}return kn.Fragment=w,kn.jsx=R,kn.jsxs=R,kn}var om;function n0(){return om||(om=1,ic.exports=i0()),ic.exports}var c=n0(),nc={exports:{}},P={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var cm;function l0(){if(cm)return P;cm=1;var p=Symbol.for("react.transitional.element"),w=Symbol.for("react.portal"),R=Symbol.for("react.fragment"),d=Symbol.for("react.strict_mode"),O=Symbol.for("react.profiler"),U=Symbol.for("react.consumer"),A=Symbol.for("react.context"),G=Symbol.for("react.forward_ref"),T=Symbol.for("react.suspense"),S=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),L=Symbol.iterator;function Q(s){return s===null||typeof s!="object"?null:(s=L&&s[L]||s["@@iterator"],typeof s=="function"?s:null)}var fe={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},re=Object.assign,we={};function $(s,y,D){this.props=s,this.context=y,this.refs=we,this.updater=D||fe}$.prototype.isReactComponent={},$.prototype.setState=function(s,y){if(typeof s!="object"&&typeof s!="function"&&s!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,s,y,"setState")},$.prototype.forceUpdate=function(s){this.updater.enqueueForceUpdate(this,s,"forceUpdate")};function Ve(){}Ve.prototype=$.prototype;function V(s,y,D){this.props=s,this.context=y,this.refs=we,this.updater=D||fe}var be=V.prototype=new Ve;be.constructor=V,re(be,$.prototype),be.isPureReactComponent=!0;var he=Array.isArray,J={H:null,A:null,T:null,S:null,V:null},Ne=Object.prototype.hasOwnProperty;function Ae(s,y,D,N,q,ae){return D=ae.ref,{$$typeof:p,type:s,key:y,ref:D!==void 0?D:null,props:ae}}function Ze(s,y){return Ae(s.type,y,void 0,void 0,void 0,s.props)}function Ye(s){return typeof s=="object"&&s!==null&&s.$$typeof===p}function St(s){var y={"=":"=0",":":"=2"};return"$"+s.replace(/[=:]/g,function(D){return y[D]})}var st=/\/+/g;function Ue(s,y){return typeof s=="object"&&s!==null&&s.key!=null?St(""+s.key):y.toString(36)}function Nt(){}function yt(s){switch(s.status){case"fulfilled":return s.value;case"rejected":throw s.reason;default:switch(typeof s.status=="string"?s.then(Nt,Nt):(s.status="pending",s.then(function(y){s.status==="pending"&&(s.status="fulfilled",s.value=y)},function(y){s.status==="pending"&&(s.status="rejected",s.reason=y)})),s.status){case"fulfilled":return s.value;case"rejected":throw s.reason}}throw s}function Oe(s,y,D,N,q){var ae=typeof s;(ae==="undefined"||ae==="boolean")&&(s=null);var K=!1;if(s===null)K=!0;else switch(ae){case"bigint":case"string":case"number":K=!0;break;case"object":switch(s.$$typeof){case p:case w:K=!0;break;case _:return K=s._init,Oe(K(s._payload),y,D,N,q)}}if(K)return q=q(s),K=N===""?"."+Ue(s,0):N,he(q)?(D="",K!=null&&(D=K.replace(st,"$&/")+"/"),Oe(q,y,D,"",function(Kt){return Kt})):q!=null&&(Ye(q)&&(q=Ze(q,D+(q.key==null||s&&s.key===q.key?"":(""+q.key).replace(st,"$&/")+"/")+K)),y.push(q)),1;K=0;var Ie=N===""?".":N+":";if(he(s))for(var ve=0;ve<s.length;ve++)N=s[ve],ae=Ie+Ue(N,ve),K+=Oe(N,y,D,ae,q);else if(ve=Q(s),typeof ve=="function")for(s=ve.call(s),ve=0;!(N=s.next()).done;)N=N.value,ae=Ie+Ue(N,ve++),K+=Oe(N,y,D,ae,q);else if(ae==="object"){if(typeof s.then=="function")return Oe(yt(s),y,D,N,q);throw y=String(s),Error("Objects are not valid as a React child (found: "+(y==="[object Object]"?"object with keys {"+Object.keys(s).join(", ")+"}":y)+"). If you meant to render a collection of children, use an array instead.")}return K}function x(s,y,D){if(s==null)return s;var N=[],q=0;return Oe(s,N,"","",function(ae){return y.call(D,ae,q++)}),N}function M(s){if(s._status===-1){var y=s._result;y=y(),y.then(function(D){(s._status===0||s._status===-1)&&(s._status=1,s._result=D)},function(D){(s._status===0||s._status===-1)&&(s._status=2,s._result=D)}),s._status===-1&&(s._status=0,s._result=y)}if(s._status===1)return s._result.default;throw s._result}var H=typeof reportError=="function"?reportError:function(s){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var y=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof s=="object"&&s!==null&&typeof s.message=="string"?String(s.message):String(s),error:s});if(!window.dispatchEvent(y))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",s);return}console.error(s)};function E(){}return P.Children={map:x,forEach:function(s,y,D){x(s,function(){y.apply(this,arguments)},D)},count:function(s){var y=0;return x(s,function(){y++}),y},toArray:function(s){return x(s,function(y){return y})||[]},only:function(s){if(!Ye(s))throw Error("React.Children.only expected to receive a single React element child.");return s}},P.Component=$,P.Fragment=R,P.Profiler=O,P.PureComponent=V,P.StrictMode=d,P.Suspense=T,P.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=J,P.__COMPILER_RUNTIME={__proto__:null,c:function(s){return J.H.useMemoCache(s)}},P.cache=function(s){return function(){return s.apply(null,arguments)}},P.cloneElement=function(s,y,D){if(s==null)throw Error("The argument must be a React element, but you passed "+s+".");var N=re({},s.props),q=s.key,ae=void 0;if(y!=null)for(K in y.ref!==void 0&&(ae=void 0),y.key!==void 0&&(q=""+y.key),y)!Ne.call(y,K)||K==="key"||K==="__self"||K==="__source"||K==="ref"&&y.ref===void 0||(N[K]=y[K]);var K=arguments.length-2;if(K===1)N.children=D;else if(1<K){for(var Ie=Array(K),ve=0;ve<K;ve++)Ie[ve]=arguments[ve+2];N.children=Ie}return Ae(s.type,q,void 0,void 0,ae,N)},P.createContext=function(s){return s={$$typeof:A,_currentValue:s,_currentValue2:s,_threadCount:0,Provider:null,Consumer:null},s.Provider=s,s.Consumer={$$typeof:U,_context:s},s},P.createElement=function(s,y,D){var N,q={},ae=null;if(y!=null)for(N in y.key!==void 0&&(ae=""+y.key),y)Ne.call(y,N)&&N!=="key"&&N!=="__self"&&N!=="__source"&&(q[N]=y[N]);var K=arguments.length-2;if(K===1)q.children=D;else if(1<K){for(var Ie=Array(K),ve=0;ve<K;ve++)Ie[ve]=arguments[ve+2];q.children=Ie}if(s&&s.defaultProps)for(N in K=s.defaultProps,K)q[N]===void 0&&(q[N]=K[N]);return Ae(s,ae,void 0,void 0,null,q)},P.createRef=function(){return{current:null}},P.forwardRef=function(s){return{$$typeof:G,render:s}},P.isValidElement=Ye,P.lazy=function(s){return{$$typeof:_,_payload:{_status:-1,_result:s},_init:M}},P.memo=function(s,y){return{$$typeof:S,type:s,compare:y===void 0?null:y}},P.startTransition=function(s){var y=J.T,D={};J.T=D;try{var N=s(),q=J.S;q!==null&&q(D,N),typeof N=="object"&&N!==null&&typeof N.then=="function"&&N.then(E,H)}catch(ae){H(ae)}finally{J.T=y}},P.unstable_useCacheRefresh=function(){return J.H.useCacheRefresh()},P.use=function(s){return J.H.use(s)},P.useActionState=function(s,y,D){return J.H.useActionState(s,y,D)},P.useCallback=function(s,y){return J.H.useCallback(s,y)},P.useContext=function(s){return J.H.useContext(s)},P.useDebugValue=function(){},P.useDeferredValue=function(s,y){return J.H.useDeferredValue(s,y)},P.useEffect=function(s,y,D){var N=J.H;if(typeof D=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return N.useEffect(s,y)},P.useId=function(){return J.H.useId()},P.useImperativeHandle=function(s,y,D){return J.H.useImperativeHandle(s,y,D)},P.useInsertionEffect=function(s,y){return J.H.useInsertionEffect(s,y)},P.useLayoutEffect=function(s,y){return J.H.useLayoutEffect(s,y)},P.useMemo=function(s,y){return J.H.useMemo(s,y)},P.useOptimistic=function(s,y){return J.H.useOptimistic(s,y)},P.useReducer=function(s,y,D){return J.H.useReducer(s,y,D)},P.useRef=function(s){return J.H.useRef(s)},P.useState=function(s){return J.H.useState(s)},P.useSyncExternalStore=function(s,y,D){return J.H.useSyncExternalStore(s,y,D)},P.useTransition=function(){return J.H.useTransition()},P.version="19.1.1",P}var sm;function fc(){return sm||(sm=1,nc.exports=l0()),nc.exports}var ne=fc(),lc={exports:{}},zn={},rc={exports:{}},oc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var um;function r0(){return um||(um=1,(function(p){function w(x,M){var H=x.length;x.push(M);e:for(;0<H;){var E=H-1>>>1,s=x[E];if(0<O(s,M))x[E]=M,x[H]=s,H=E;else break e}}function R(x){return x.length===0?null:x[0]}function d(x){if(x.length===0)return null;var M=x[0],H=x.pop();if(H!==M){x[0]=H;e:for(var E=0,s=x.length,y=s>>>1;E<y;){var D=2*(E+1)-1,N=x[D],q=D+1,ae=x[q];if(0>O(N,H))q<s&&0>O(ae,N)?(x[E]=ae,x[q]=H,E=q):(x[E]=N,x[D]=H,E=D);else if(q<s&&0>O(ae,H))x[E]=ae,x[q]=H,E=q;else break e}}return M}function O(x,M){var H=x.sortIndex-M.sortIndex;return H!==0?H:x.id-M.id}if(p.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var U=performance;p.unstable_now=function(){return U.now()}}else{var A=Date,G=A.now();p.unstable_now=function(){return A.now()-G}}var T=[],S=[],_=1,L=null,Q=3,fe=!1,re=!1,we=!1,$=!1,Ve=typeof setTimeout=="function"?setTimeout:null,V=typeof clearTimeout=="function"?clearTimeout:null,be=typeof setImmediate<"u"?setImmediate:null;function he(x){for(var M=R(S);M!==null;){if(M.callback===null)d(S);else if(M.startTime<=x)d(S),M.sortIndex=M.expirationTime,w(T,M);else break;M=R(S)}}function J(x){if(we=!1,he(x),!re)if(R(T)!==null)re=!0,Ne||(Ne=!0,Ue());else{var M=R(S);M!==null&&Oe(J,M.startTime-x)}}var Ne=!1,Ae=-1,Ze=5,Ye=-1;function St(){return $?!0:!(p.unstable_now()-Ye<Ze)}function st(){if($=!1,Ne){var x=p.unstable_now();Ye=x;var M=!0;try{e:{re=!1,we&&(we=!1,V(Ae),Ae=-1),fe=!0;var H=Q;try{t:{for(he(x),L=R(T);L!==null&&!(L.expirationTime>x&&St());){var E=L.callback;if(typeof E=="function"){L.callback=null,Q=L.priorityLevel;var s=E(L.expirationTime<=x);if(x=p.unstable_now(),typeof s=="function"){L.callback=s,he(x),M=!0;break t}L===R(T)&&d(T),he(x)}else d(T);L=R(T)}if(L!==null)M=!0;else{var y=R(S);y!==null&&Oe(J,y.startTime-x),M=!1}}break e}finally{L=null,Q=H,fe=!1}M=void 0}}finally{M?Ue():Ne=!1}}}var Ue;if(typeof be=="function")Ue=function(){be(st)};else if(typeof MessageChannel<"u"){var Nt=new MessageChannel,yt=Nt.port2;Nt.port1.onmessage=st,Ue=function(){yt.postMessage(null)}}else Ue=function(){Ve(st,0)};function Oe(x,M){Ae=Ve(function(){x(p.unstable_now())},M)}p.unstable_IdlePriority=5,p.unstable_ImmediatePriority=1,p.unstable_LowPriority=4,p.unstable_NormalPriority=3,p.unstable_Profiling=null,p.unstable_UserBlockingPriority=2,p.unstable_cancelCallback=function(x){x.callback=null},p.unstable_forceFrameRate=function(x){0>x||125<x?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Ze=0<x?Math.floor(1e3/x):5},p.unstable_getCurrentPriorityLevel=function(){return Q},p.unstable_next=function(x){switch(Q){case 1:case 2:case 3:var M=3;break;default:M=Q}var H=Q;Q=M;try{return x()}finally{Q=H}},p.unstable_requestPaint=function(){$=!0},p.unstable_runWithPriority=function(x,M){switch(x){case 1:case 2:case 3:case 4:case 5:break;default:x=3}var H=Q;Q=x;try{return M()}finally{Q=H}},p.unstable_scheduleCallback=function(x,M,H){var E=p.unstable_now();switch(typeof H=="object"&&H!==null?(H=H.delay,H=typeof H=="number"&&0<H?E+H:E):H=E,x){case 1:var s=-1;break;case 2:s=250;break;case 5:s=1073741823;break;case 4:s=1e4;break;default:s=5e3}return s=H+s,x={id:_++,callback:M,priorityLevel:x,startTime:H,expirationTime:s,sortIndex:-1},H>E?(x.sortIndex=H,w(S,x),R(T)===null&&x===R(S)&&(we?(V(Ae),Ae=-1):we=!0,Oe(J,H-E))):(x.sortIndex=s,w(T,x),re||fe||(re=!0,Ne||(Ne=!0,Ue()))),x},p.unstable_shouldYield=St,p.unstable_wrapCallback=function(x){var M=Q;return function(){var H=Q;Q=M;try{return x.apply(this,arguments)}finally{Q=H}}}})(oc)),oc}var dm;function o0(){return dm||(dm=1,rc.exports=r0()),rc.exports}var cc={exports:{}},Qe={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var mm;function c0(){if(mm)return Qe;mm=1;var p=fc();function w(T){var S="https://react.dev/errors/"+T;if(1<arguments.length){S+="?args[]="+encodeURIComponent(arguments[1]);for(var _=2;_<arguments.length;_++)S+="&args[]="+encodeURIComponent(arguments[_])}return"Minified React error #"+T+"; visit "+S+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function R(){}var d={d:{f:R,r:function(){throw Error(w(522))},D:R,C:R,L:R,m:R,X:R,S:R,M:R},p:0,findDOMNode:null},O=Symbol.for("react.portal");function U(T,S,_){var L=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:O,key:L==null?null:""+L,children:T,containerInfo:S,implementation:_}}var A=p.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function G(T,S){if(T==="font")return"";if(typeof S=="string")return S==="use-credentials"?S:""}return Qe.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=d,Qe.createPortal=function(T,S){var _=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!S||S.nodeType!==1&&S.nodeType!==9&&S.nodeType!==11)throw Error(w(299));return U(T,S,null,_)},Qe.flushSync=function(T){var S=A.T,_=d.p;try{if(A.T=null,d.p=2,T)return T()}finally{A.T=S,d.p=_,d.d.f()}},Qe.preconnect=function(T,S){typeof T=="string"&&(S?(S=S.crossOrigin,S=typeof S=="string"?S==="use-credentials"?S:"":void 0):S=null,d.d.C(T,S))},Qe.prefetchDNS=function(T){typeof T=="string"&&d.d.D(T)},Qe.preinit=function(T,S){if(typeof T=="string"&&S&&typeof S.as=="string"){var _=S.as,L=G(_,S.crossOrigin),Q=typeof S.integrity=="string"?S.integrity:void 0,fe=typeof S.fetchPriority=="string"?S.fetchPriority:void 0;_==="style"?d.d.S(T,typeof S.precedence=="string"?S.precedence:void 0,{crossOrigin:L,integrity:Q,fetchPriority:fe}):_==="script"&&d.d.X(T,{crossOrigin:L,integrity:Q,fetchPriority:fe,nonce:typeof S.nonce=="string"?S.nonce:void 0})}},Qe.preinitModule=function(T,S){if(typeof T=="string")if(typeof S=="object"&&S!==null){if(S.as==null||S.as==="script"){var _=G(S.as,S.crossOrigin);d.d.M(T,{crossOrigin:_,integrity:typeof S.integrity=="string"?S.integrity:void 0,nonce:typeof S.nonce=="string"?S.nonce:void 0})}}else S==null&&d.d.M(T)},Qe.preload=function(T,S){if(typeof T=="string"&&typeof S=="object"&&S!==null&&typeof S.as=="string"){var _=S.as,L=G(_,S.crossOrigin);d.d.L(T,_,{crossOrigin:L,integrity:typeof S.integrity=="string"?S.integrity:void 0,nonce:typeof S.nonce=="string"?S.nonce:void 0,type:typeof S.type=="string"?S.type:void 0,fetchPriority:typeof S.fetchPriority=="string"?S.fetchPriority:void 0,referrerPolicy:typeof S.referrerPolicy=="string"?S.referrerPolicy:void 0,imageSrcSet:typeof S.imageSrcSet=="string"?S.imageSrcSet:void 0,imageSizes:typeof S.imageSizes=="string"?S.imageSizes:void 0,media:typeof S.media=="string"?S.media:void 0})}},Qe.preloadModule=function(T,S){if(typeof T=="string")if(S){var _=G(S.as,S.crossOrigin);d.d.m(T,{as:typeof S.as=="string"&&S.as!=="script"?S.as:void 0,crossOrigin:_,integrity:typeof S.integrity=="string"?S.integrity:void 0})}else d.d.m(T)},Qe.requestFormReset=function(T){d.d.r(T)},Qe.unstable_batchedUpdates=function(T,S){return T(S)},Qe.useFormState=function(T,S,_){return A.H.useFormState(T,S,_)},Qe.useFormStatus=function(){return A.H.useHostTransitionStatus()},Qe.version="19.1.1",Qe}var fm;function Sm(){if(fm)return cc.exports;fm=1;function p(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(p)}catch(w){console.error(w)}}return p(),cc.exports=c0(),cc.exports}/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const U0=ne.forwardRef(({color:p="currentColor",size:w=24,strokeWidth:R=2,absoluteStrokeWidth:d,className:O="",children:U,iconNode:A,...G},T)=>ne.createElement("svg",{ref:T,...N0,width:w,height:w,stroke:p,strokeWidth:d?Number(R)*24/Number(w):R,className:Dm("lucide",O),...!U&&!M0(G)&&{"aria-hidden":"true"},...G},[...A.map(([S,_])=>ne.createElement(S,_)),...Array.isArray(U)?U:[U]]));/**
 * @license lucide-react v0.543.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const pe=(p,w)=>{const R=ne.forwardRef(({className:d,...O},U)=>ne.createElement(U0,{ref:U,iconNode:w,className:Dm(`lucide-${A0(bm(p))}`,`lucide-${p}`,d),...O}));return R.displayName=bm(p),R};/**
 * @license lucide-react v0.543.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _0=[["path",{d:"M12 7v14",key:"1akyts"}],["path",{d:"M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z",key:"ruj8y"}]],C0=pe("book-open",_0);/**
 * @license lucide-react v0.543.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const R0=[["path",{d:"M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16",key:"jecpp"}],["rect",{width:"20",height:"14",x:"2",y:"6",rx:"2",key:"i6l2r4"}]],Gl=pe("briefcase",R0);/**
 * @license lucide-react v0.543.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const mp=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],Om=pe("x",mp),sc=[{id:"personal"},{id:"experience"},{id:"projects"},{id:"education"}],fp=()=>{const[p,w]=ne.useState(!1),[R,d]=ne.useState("personal"),{theme:O,toggleTheme:U,isDark:A}=f0(),{language:G,toggleLanguage:T,t:S}=zi(),_=L=>{const Q=document.getElementById(L);Q&&Q.scrollIntoView({behavior:"smooth",block:"start"}),w(!1)};return ne.useEffect(()=>{const L=()=>{const Q=sc.map(re=>re.id),fe=window.scrollY+100;for(const re of Q){const we=document.getElementById(re);if(we){const{offsetTop:$,offsetHeight:Ve}=we;if(fe>=$&&fe<$+Ve){d(re);break}}}};return window.addEventListener("scroll",L),()=>window.removeEventListener("scroll",L)},[]),c.jsxs("nav",{className:"navigation",children:[c.jsxs("div",{className:"nav-container",children:[c.jsx("div",{className:"nav-brand",children:c.jsx("h3",{children:"KBB"})}),c.jsx("ul",{className:"nav-menu",children:sc.map(L=>c.jsx("li",{className:"nav-item",children:c.jsx("button",{onClick:()=>_(L.id),className:`nav-link ${R===L.id?"active":""}`,"aria-label":`Navigate to ${S(`navigation.${L.id}`)} section`,children:S(`navigation.${L.id}`)})},L.id))}),c.jsxs("div",{className:"control-buttons",children:[c.jsxs("button",{onClick:T,className:"language-toggle","aria-label":`Switch to ${G==="en"?"Turkish":"English"}`,title:`Switch to ${G==="en"?"Turkish":"English"}`,children:[c.jsx(dc,{size:18}),c.jsx("span",{className:"language-text",children:G.toUpperCase()})]}),c.jsx("button",{onClick:U,className:"theme-toggle","aria-label":`Switch to ${A?"light":"dark"} mode`,title:`Switch to ${A?"light":"dark"} mode`,children:A?c.jsx(km,{size:20}):c.jsx(xm,{size:20})})]}),c.jsx("button",{className:"mobile-menu-toggle",onClick:()=>w(!p),"aria-label":"Toggle mobile menu",children:p?c.jsx(Om,{size:24}):c.jsx(ap,{size:24})})]}),p&&c.jsxs("div",{className:"mobile-menu",children:[sc.map(L=>c.jsx("button",{onClick:()=>_(L.id),className:`mobile-nav-link ${R===L.id?"active":""}`,children:S(`navigation.${L.id}`)},L.id)),c.jsxs("button",{onClick:T,className:"mobile-language-toggle","aria-label":`Switch to ${G==="en"?"Turkish":"English"}`,children:[c.jsx(dc,{size:20}),G==="en"?"Türkçe":"English"]}),c.jsxs("button",{onClick:U,className:"mobile-theme-toggle","aria-label":`Switch to ${A?"light":"dark"} mode`,children:[A?c.jsx(km,{size:20}):c.jsx(xm,{size:20}),A?G==="en"?"Light Mode":"Açık Mod":G==="en"?"Dark Mode":"Koyu Mod"]})]}),c.jsx("style",{jsx:!0,children:`
        .navigation {
          position: fixed;
          top: 0;
          left: 0;
      ...
      `})]})},gp="/Portfolio/assets/MePhoto.jpg",pp=()=>{const[p,w]=ne.useState(!1),[R,d]=ne.useState(!1),{language:O,t:U}=zi(),A=()=>{w(!0);const T=encodeURIComponent(U("personalInfo.emailSubject")),S=encodeURIComponent(U("personalInfo.emailBody")),_=`https://mail.google.com/mail/?view=cm&to=batuhankelami@gmail.com&su=${T}&body=${S}`;window.open(_,"_blank"),setTimeout(()=>{w(!1)},3e3)},G=()=>{d(!0);const T=document.createElement("a");T.href="/Portfolio/cv.pdf",T.download="Kelami_Batuhan_CV.pdf",T.click(),setTimeout(()=>{d(!1)},3e3)};return c.jsxs("div",{className:"personal-info",children:[c.jsx("div",{className:"container",children:c.jsxs("div",{className:"personal-content",children:[c.jsxs("div",{className:"personal-text",children:[c.jsxs("div",{className:"intro-text fade-in-up",children:[c.jsxs("h1",{className:"main-title",children:[U("personalInfo.greeting")," ",c.jsx("span",{className:"highlight",children:U("personalInfo.name")})]}),c.jsx("h2",{className:"subtitle",children:U("personalInfo.title")}),c.jsx("p",{className:"description",children:U("personalInfo.description")})]}),c.jsxs("div",{className:"cta-buttons fade-in-up",children:[c.jsxs("button",{onClick:A,className:`btn btn-primary ${p?"btn-success":""}`,"aria-label":"Contact via email",disabled:p,children:[p?c.jsx(ym,{size:20}):c.jsx(mc,{size:20}),U(p?"personalInfo.emailOpened":"personalInfo.getInTouch")]}),c.jsxs("button",{onClick:G,className:`btn btn-outline ${R?"btn-success":""}`,"aria-label":"Download resume",disabled:R,children:[R?c.jsx(ym,{size:20}):c.jsx(L0,{size:20}),U(R?"personalInfo.downloaded":"personalInfo.downloadCV")]})]}),c.jsxs("div",{className:"social-links fade-in-up",children:[c.jsx("a",{href:"https://github.com/KBatuhanB",target:"_blank",rel:"noopener noreferrer",className:"social-link","aria-label":U("personalInfo.githubProfile"),children:c.jsx(ql,{size:24})}),c.jsx("a",{href:"https://www.linkedin.com/in/batuhan-b%C3%B6l%C3%BCkba%C5%9F%C4%B1-45b2b726b/",target:"_blank",rel:"noopener noreferrer",className:"social-link","aria-label":U("personalInfo.linkedinProfile"),children:c.jsx(Mm,{size:24})}),c.jsx("button",{className:"social-link","aria-label":U("personalInfo.emailContact"),type:"button",onClick:A,children:c.jsx(mc,{size:24})})]})]}),c.jsx("div",{className:"personal-image fade-in-up",children:c.jsxs("div",{className:"image-container",children:[c.jsx("div",{className:"profile-placeholder",children:c.jsx("img",{src:gp,alt:U("personalInfo.name"),className:"profile-image",style:{width:"100%",height:"100%",objectFit:"cover",borderRadius:"20px"}})}),c.jsx("div",{className:"image-decoration decoration-1"}),c.jsx("div",{className:"image-decoration decoration-2"})]})})]})}),c.jsx("style",{jsx:!0,children:`
        .personal-info {
          min-height: 90vh;
          display: flex;
          align-items: center;
      ...
      `})]})};var vp=Sm();const yp=[{id:1,key:"collectify",categories:["web","backend"],technologies:["React.js","Node.js","Express.js","MongoDB","TypeScript","Material-UI","Jest","Playwright","Chart.js","Multer"],images:["/Portfolio/assets/Collectify1.png","/Portfolio/assets/Collectify2.png","/Portfolio/assets/Collectify3.png","/Portfolio/assets/Collectify4.png"],image:"/api/placeholder/400/250",demoUrl:null,githubUrl:"https://github.com/KBatuhanB/Collectify-Books-Movies-Games-Collection-Manager-Full-Stack-",featured:!0,status:"completed"},{id:2,key:"projectManagement",categories:["web","backend"],technologies:["React","Material-UI","Recharts","React Query","Node.js","Express","MongoDB","Axios"],images:["/Portfolio/assets/ProjectManagment.png","/Portfolio/assets/ProjectManagment2.png"],image:"/api/placeholder/400/250",demoUrl:null,githubUrl:"https://github.com/KBatuhanB/Project-Management-Panel",featured:!0,status:"completed"},{id:7,key:"pythonIn20Days",categories:["mobile"],technologies:["Kotlin","Jetpack Compose","Material 3","MVVM","Navigation Component","SharedPreferences","Custom Animations","Manual DI","Gradle","Android Studio"],images:["/Portfolio/assets/PyhtonIn20Days1.jpg","/Portfolio/assets/PyhtonIn20Days2.jpg","/Portfolio/assets/PyhtonIn20Days3.jpg","/Portfolio/assets/PyhtonIn20Days4.jpg"],image:"/api/placeholder/400/250",demoUrl:"https://drive.google.com/file/d/1AoQr3gtaGzhfCeQ5O3BWnc5oRgzJyWsZ/view?usp=sharing",githubUrl:"https://github.com/KBatuhanB/Kotlin-Mobill-App-PhytonIn20Days",featured:!0,status:"completed"},{id:8,key:"axolotlAscension",categories:["game"],technologies:["Unity","C#","Coroutines","Object Pooling","Singleton Pattern","State Machine","Git"],images:["/Portfolio/assets/AxoltlAccension1.png","/Portfolio/assets/AxoltlAccension2.png","/Portfolio/assets/AxoltlAccension3.png","/Portfolio/assets/AxoltlAccension4.png","/Portfolio/assets/AxoltlAccension5.png"],image:"/api/placeholder/400/250",demoUrl:"https://fiuby.com/games/axolotl-ascension",githubUrl:"https://github.com/KBatuhanB/Ankus-Axos-GameJam-Game",featured:!0,status:"completed"},{id:9,key:"paperTale",categories:["game"],technologies:["Unity","C#","Level Design","Game Design","Storytelling","Narrative Design"],images:["/Portfolio/assets/PaperTale.png","/Portfolio/assets/PaperTale1.png","/Portfolio/assets/PaperTale2.png","/Portfolio/assets/PaperTale3.png","/Portfolio/assets/PaperTale4.png","/Portfolio/assets/PaperTale5.png"],image:"/api/placeholder/400/250",demoUrl:"https://erque.itch.io/papertale",featured:!0,status:"completed"},{id:10,key:"vslikeGame",categories:["game"],technologies:["Unity","C#","Game Design","UI/UX Design","Marketing","Solo Development","Indie Game Development"],images:["/Portfolio/assets/vslike1.png","/Portfolio/assets/vslike2.png","/Portfolio/assets/vslike3.png","/Portfolio/assets/vslike4.png"],image:"/api/placeholder/400/250",demoUrl:"https://www.youtube.com/@0toMillion-dev",githubUrl:null,featured:!0,status:"in-progress"},{id:3,key:"todoApi",categories:["backend"],technologies:["Node.js","Express.js","MongoDB","Swagger","Jest","UUID","dotenv"],images:["/Portfolio/assets/TOD-API.png"],demoUrl:null,githubUrl:"https://github.com/KBatuhanB/Todo-API",featured:!1,status:"completed"},{id:4,key:"softwareTestingSuite",categories:["testing"],technologies:["Playwright","Jest","Node.js","MongoDB","JavaScript"],images:["/Portfolio/assets/Playwright1.png","/Portfolio/assets/Playwright2.png"],demoUrl:null,githubUrl:"https://github.com/KBatuhanB/Software-Tests",featured:!1,status:"completed"},{id:5,key:"pythonSeleniumAutomation",categories:["testing"],technologies:["Python","Selenium","Web Automation","Data Structures"],images:["/Portfolio/assets/pyhtonExample1.png"],demoUrl:null,githubUrl:"https://github.com/KBatuhanB/Phyton-Selenium-Tests-Examples",featured:!1,status:"completed"}],xp=[{id:"all",label:"projects.allFilter",icon:c.jsx(va,{size:20})},{id:"web",label:"projects.webFilter",icon:c.jsx(dc,{size:20})},{id:"backend",label:"projects.backendFilter",icon:c.jsx(op,{size:20})},{id:"game",label:"projects.gameFilter",icon:c.jsx(uc,{size:20})},{id:"mobile",label:"projects.mobileFilter",icon:c.jsx(sp,{size:20})},{id:"testing",label:"projects.toolsFilter",icon:c.jsx(va,{size:20})}],kp=()=>{const{t:p}=zi(),[w,R]=ne.useState("all"),[d,O]=ne.useState(null),[U,A]=ne.useState(!1),[G,T]=ne.useState(1),[S,_]=ne.useState({}),[L,Q]=ne.useState({}),[fe,re]=ne.useState({}),[we,$]=ne.useState({}),V=yp.map(E=>{const y=p("projects.data")?.[E.key];return{...E,title:y?.title||E.key,description:y?.description||[],detailedInfo:y?.detailedInfo||{}}}),be=E=>{O(E),A(!0),document.body.style.overflow="hidden"},he=()=>{A(!1),O(null),document.body.style.overflow="unset"},J=w==="all"?V:V.filter(E=>E.categories.includes(w)),Ne=()=>window.innerWidth<=768?4:6,[Ae,Ze]=ne.useState(Ne());ne.useEffect(()=>{const E=()=>{const s=Ne();s!==Ae&&(Ze(s),T(1))};return window.addEventListener("resize",E),()=>window.removeEventListener("resize",E)},[Ae]);const Ye=Math.ceil(J.length/Ae),St=(G-1)*Ae,st=St+Ae,Ue=J.slice(St,st);ne.useEffect(()=>{const E={};return V.forEach(s=>{s.images&&s.images.length>1&&(E[s.id]=setInterval(()=>{re(y=>({...y,[s.id]:"fade-out"})),setTimeout(()=>{_(y=>({...y,[s.id]:((y[s.id]||0)+1)%s.images.length})),re(y=>({...y,[s.id]:"fade-in"})),setTimeout(()=>{re(y=>({...y,[s.id]:""}))},1200)},600)},4e3))}),()=>{Object.values(E).forEach(s=>clearInterval(s))}},[V]);const Nt=E=>{R(E),T(1)},yt=E=>{T(E),document.querySelector(".projects")?.scrollIntoView({behavior:"smooth"})},Oe=()=>{G>1&&yt(G-1)},x=()=>{G<Ye&&yt(G+1)};ne.useEffect(()=>{if(U&&d?.images&&d.images.length>1){const E=setInterval(()=>{$(s=>({...s,[d.id]:"fade-out"})),setTimeout(()=>{Q(s=>({...s,[d.id]:((s[d.id]||0)+1)%d.images.length})),$(s=>({...s,[d.id]:"fade-in"})),setTimeout(()=>{$(s=>({...s,[d.id]:""}))},1200)},600)},4e3);return()=>clearInterval(E)}},[U,d]);const M=E=>{switch(E){case"completed":return"#9333EA";case"in-progress":return"#06B6D4";case"planned":return"#1D4ED8";default:return"#9333EA"}},H=E=>{switch(E){case"completed":return p("projects.status.completed");case"in-progress":return p("projects.status.inProgress");case"planned":return p("projects.status.planned");default:return p("projects.status.completed")}};return c.jsxs("div",{className:"projects",children:[c.jsxs("div",{className:"container",children:[c.jsxs("div",{className:"section-header",children:[c.jsx("h2",{className:"section-title fade-in-up",children:p("projects.title")}),c.jsx("p",{className:"section-description fade-in-up",children:p("projects.description")})]}),c.jsx("div",{className:"project-filters fade-in-up",children:xp.map(E=>c.jsxs("button",{onClick:()=>Nt(E.id),className:`filter-button ${w===E.id?"active":""}`,"aria-label":`Filter by ${p(E.label)}`,children:[E.icon,p(E.label)]},E.id))}),c.jsx("div",{className:"projects-grid",children:Ue.map((E,s)=>c.jsxs("div",{className:`project-card card fade-in-up ${E.featured?"featured":""}`,style:{animationDelay:`${s*.1}s`},onClick:()=>be(E),children:[c.jsxs("div",{className:"project-image",children:[E.images&&E.images.length>0?c.jsxs("div",{className:"image-gallery",style:{"--bg-image":`url(${E.images[S[E.id]||0]})`},children:[c.jsx("img",{src:E.images[S[E.id]||0],alt:`${E.title} screenshot`,className:`project-screenshot ${fe[E.id]||""}`,onError:y=>{y.target.style.display="none",y.target.nextSibling.style.display="flex"}}),c.jsx("div",{className:"image-placeholder",style:{display:"none"},children:c.jsxs("div",{className:"placeholder-content",children:[c.jsx(va,{size:48}),c.jsx("p",{children:"Project Screenshot"})]})}),E.images.length>1&&c.jsx("div",{className:"image-indicators",children:E.images.map((y,D)=>c.jsx("div",{className:`indicator ${(S[E.id]||0)===D?"active":""}`},D))})]}):c.jsx("div",{className:"image-placeholder",children:c.jsxs("div",{className:"placeholder-content",children:[c.jsx(va,{size:48}),c.jsx("p",{children:"Project Screenshot"})]})}),c.jsx("div",{className:"status-badge",style:{backgroundColor:M(E.status)},children:H(E.status)}),E.featured&&c.jsx("div",{className:"featured-star",children:c.jsx(Um,{size:20})})]}),c.jsxs("div",{className:"project-content",children:[c.jsx("h3",{className:"project-title",children:E.title}),c.jsx("div",{className:"project-description",children:Array.isArray(E.description)?c.jsx("ul",{className:"description-list",children:E.description.map((y,D)=>c.jsx("li",{children:y},D))}):c.jsx("p",{children:E.description})}),c.jsx("div",{className:"project-technologies",children:c.jsxs("div",{className:"tech-carousel",children:[E.technologies.map(y=>c.jsx("span",{className:"tech-tag",children:y},y)),E.technologies.map((y,D)=>c.jsx("span",{className:"tech-tag",children:y},`${y}-duplicate-${D}`))]})}),c.jsxs("div",{className:`project-links ${E.demoUrl&&E.githubUrl?"multiple-links":"single-link"}`,children:[E.demoUrl&&c.jsxs("a",{href:E.demoUrl,target:"_blank",rel:"noopener noreferrer",className:"project-link demo-link","aria-label":`View live demo of ${E.title}`,onClick:y=>y.stopPropagation(),children:[c.jsx(Hl,{size:18}),p("projects.viewLive")]}),E.githubUrl&&c.jsxs("a",{href:E.githubUrl,target:"_blank",rel:"noopener noreferrer",className:"project-link source-link","aria-label":`View source code of ${E.title}`,onClick:y=>y.stopPropagation(),children:[c.jsx(ql,{size:18}),p("projects.viewCode")]})]})]})]},E.id))}),Ye>1&&c.jsxs("div",{className:"pagination-container fade-in-up",children:[c.jsxs("div",{className:"pagination",children:[c.jsxs("button",{className:`pagination-btn ${G===1?"disabled":""}`,onClick:Oe,disabled:G===1,"aria-label":"Go to previous page",children:[c.jsx(Am,{size:20}),p("projects.previous")]}),c.jsx("div",{className:"pagination-numbers",children:Array.from({length:Ye},(E,s)=>s+1).map(E=>c.jsx("button",{className:`pagination-number ${G===E?"active":""}`,onClick:()=>yt(E),"aria-label":`Go to page ${E}`,children:E},E))}),c.jsxs("button",{className:`pagination-btn ${G===Ye?"disabled":""}`,onClick:x,disabled:G===Ye,"aria-label":"Go to next page",children:[p("projects.next"),c.jsx(Tm,{size:20})]})]}),c.jsxs("div",{className:"pagination-info",children:[p("projects.showing")," ",St+1,"-",Math.min(st,J.length)," ",p("projects.of")," ",J.length," ",p("projects.projects")]})]}),J.length===0&&c.jsxs("div",{className:"empty-state",children:[c.jsx(va,{size:64}),c.jsx("h3",{children:"No projects found"}),c.jsx("p",{children:"No projects match the selected category."})]})]}),U&&d&&vp.createPortal(c.jsx("div",{className:"modal-overlay",onClick:he,children:c.jsxs("div",{className:"modal-content",onClick:E=>E.stopPropagation(),children:[c.jsxs("div",{className:"modal-header",children:[c.jsx("h2",{className:"modal-title",children:d.title}),c.jsx("button",{className:"modal-close-btn",onClick:he,"aria-label":"Close modal",children:c.jsx(Om,{size:24})})]}),c.jsxs("div",{className:"modal-body",children:[d.images&&d.images.length>0?c.jsxs("div",{className:"modal-image-gallery",style:{"--modal-bg-image":`url(${d.images[L[d.id]||0]})`},children:[c.jsx("img",{src:d.images[L[d.id]||0],alt:`${d.title} screenshot`,className:`modal-screenshot ${we[d.id]||""}`,onError:E=>{E.target.style.display="none",E.target.nextSibling.style.display="flex"}}),c.jsx("div",{className:"modal-image-placeholder",style:{display:"none"},children:c.jsxs("div",{className:"placeholder-content",children:[c.jsx(va,{size:64}),c.jsx("p",{children:"Project Screenshot"})]})}),d.images.length>1&&c.jsx("div",{className:"modal-image-indicators",children:d.images.map((E,s)=>c.jsx("div",{className:`modal-indicator ${(L[d.id]||0)===s?"active":""}`,onClick:()=>{$(y=>({...y,[d.id]:"fade-out"})),setTimeout(()=>{Q(y=>({...y,[d.id]:s})),$(y=>({...y,[d.id]:"fade-in"})),setTimeout(()=>{$(y=>({...y,[d.id]:""}))},1200)},600)}},s))})]}):c.jsx("div",{className:"modal-image",children:c.jsx("div",{className:"image-placeholder",children:c.jsxs("div",{className:"placeholder-content",children:[c.jsx(va,{size:64}),c.jsx("p",{children:"Project Screenshot"})]})})}),c.jsxs("div",{className:"modal-section",children:[c.jsx("h3",{children:p("projects.modal.projectOverview")}),c.jsx("p",{children:d.detailedInfo?.overview||"No detailed overview available."})]}),d.detailedInfo?.features&&c.jsxs("div",{className:"modal-section",children:[c.jsx("h3",{children:p("projects.modal.keyFeatures")}),c.jsx("ul",{className:"feature-list",children:d.detailedInfo.features.map((E,s)=>c.jsx("li",{children:E},s))})]}),d.detailedInfo?.techDetails&&c.jsxs("div",{className:"modal-section",children:[c.jsx("h3",{children:p("projects.modal.technicalStack")}),c.jsx("div",{className:"tech-details",children:Object.entries(d.detailedInfo.techDetails).map(([E,s])=>c.jsxs("div",{className:"tech-category",children:[c.jsx("h4",{children:E}),c.jsx("div",{className:"tech-items",children:s.map((y,D)=>c.jsx("span",{className:"tech-item",children:y},D))})]},E))})]}),d.detailedInfo?.learningOutcomes&&c.jsxs("div",{className:"modal-section",children:[c.jsx("h3",{children:p("projects.modal.learningOutcomes")}),c.jsx("ul",{className:"learning-list",children:d.detailedInfo.learningOutcomes.map((E,s)=>c.jsx("li",{children:E},s))})]}),c.jsxs("div",{className:"modal-links",children:[d.demoUrl&&c.jsxs("a",{href:d.demoUrl,target:"_blank",rel:"noopener noreferrer",className:"modal-link demo-link",children:[c.jsx(Hl,{size:18}),p("projects.viewLive")]}),d.githubUrl&&c.jsxs("a",{href:d.githubUrl,target:"_blank",rel:"noopener noreferrer",className:"modal-link source-link",children:[c.jsx(ql,{size:18}),p("projects.viewCode")]})]})]})]})}),document.body),c.jsx("style",{jsx:!0,children:`
        .projects {
          background: var(--background);
          position: relative;
          overflow: hidden;
      ...
      `})]})},zp=[{id:1,key:"gaziUniversity",status:"current"},{id:2,key:"ankaraMedipolUniversity",status:"completed"}],Sp=()=>{const{t:p}=zi(),w=O=>({institution:p(`education.educations.${O}.institution`),degree:p(`education.educations.${O}.degree`),duration:p(`education.educations.${O}.duration`),location:p(`education.educations.${O}.location`),gpa:p(`education.educations.${O}.gpa`),description:p(`education.educations.${O}.description`),achievements:p(`education.educations.${O}.achievements`)}),R=O=>{switch(O){case"current":return"var(--primary-color)";case"completed":return"#9333EA";default:return"var(--primary-color)"}},d=O=>{switch(O){case"current":return p("education.current");case"completed":return p("education.completed");default:return p("education.current")}};return c.jsxs("div",{className:"education",children:[c.jsxs("div",{className:"container",children:[c.jsxs("div",{className:"section-header",children:[c.jsx("h2",{className:"section-title fade-in-up",children:p("education.title")}),c.jsx("p",{className:"section-description fade-in-up",children:p("education.description")})]}),c.jsx("div",{className:"education-content",children:c.jsxs("div",{className:"formal-education",children:[c.jsxs("h3",{className:"subsection-title",children:[c.jsx($0,{size:24}),p("education.academicBackground")]}),c.jsx("div",{className:"education-timeline",children:zp.map((O,U)=>{const A=w(O.key);return c.jsx("div",{className:"education-item fade-in-up",children:c.jsxs("div",{className:"education-card card",children:[c.jsxs("div",{className:"education-header",children:[c.jsxs("div",{className:"education-main",children:[c.jsx("h4",{className:"education-degree",children:A.degree}),c.jsx("h5",{className:"education-institution",children:A.institution}),c.jsxs("div",{className:"education-meta",children:[c.jsxs("span",{className:"education-duration",children:[c.jsx(wm,{size:16}),A.duration]}),c.jsxs("span",{className:"education-location",children:[c.jsx(C0,{size:16}),A.location]}),A.gpa&&c.jsxs("span",{className:"education-gpa",children:[c.jsx(Um,{size:16}),"GPA: ",A.gpa]})]})]}),c.jsx("div",{className:"status-badge",style:{backgroundColor:R(O.status)},children:d(O.status)})]}),c.jsx("p",{className:"education-description",children:A.description}),c.jsxs("div",{className:"achievements-section",children:[c.jsx("h6",{className:"detail-title",children:p("education.achievements")}),c.jsx("ul",{className:"achievements-list",children:Array.isArray(A.achievements)?A.achievements.map((G,T)=>c.jsxs("li",{className:"achievement-item",children:[c.jsx(vm,{size:16}),G]},T)):c.jsxs("li",{className:"achievement-item",children:[c.jsx(vm,{size:16}),A.achievements]})})]})]})},O.id)})})]})})]}),c.jsx("style",{jsx:!0,children:`
        .education {
          position: relative;
          overflow: hidden;
        }
